...
Each feature in this project has its own doc in this folder. Feature docs are the committed source of truth for acceptance criteria, task tracking, and technical notes.
...
Use the template in [AI_AGENT_INSTRUCTIONS.md](../04-Development/AI_AGENT_INSTRUCTIONS.md#feature-doc-format).
